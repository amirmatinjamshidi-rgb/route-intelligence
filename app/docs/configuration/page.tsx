  ...
  rules: {
    ...
    'redirect-cycle': 'error',
        ...
        <Callout kind="note" title="Sensible defaults">
          ...
          <InlineCode>['app/**', 'pages/**', 'src/**', 'middleware.ts']</InlineCode> for includes
          and ignores <InlineCode>node_modules</InlineCode>, <InlineCode>.next</InlineCode>,{' '}
          <InlineCode>dist</InlineCode>, and test files.
        </Callout>

        <H2 id="rules">Rules</H2>
        <P>
          The <InlineCode>rules</InlineCode> map overrides diagnostic severities. Accepted values
          are <InlineCode>error</InlineCode>, <InlineCode>warn</InlineCode>, and{' '}
