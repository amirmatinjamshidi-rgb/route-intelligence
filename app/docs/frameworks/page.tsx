    ...
    >
      <Prose>
        ...
        <P>
          ...
          <InlineCode>page</InlineCode>, <InlineCode>layout</InlineCode>, <InlineCode>template</InlineCode>,{" "}
          <InlineCode>loading</InlineCode>, <InlineCode>error</InlineCode>,{" "}
          <InlineCode>not-found</InlineCode>, <InlineCode>forbidden</InlineCode>,{" "}
          <InlineCode>unauthorized</InlineCode>, route handlers, and middleware.
        </P>
        <CodeBlock
          language="ts"
