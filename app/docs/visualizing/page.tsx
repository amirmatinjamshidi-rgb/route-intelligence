  ...
  return (
    ...
    >
      <Prose>
        ...
        <CodeBlock language="bash" code={`route-intelligence analyze --format mermaid --out ri-output`} />
        <P>
        ...
        <CodeBlock language="bash" code={`route-intelligence docs --format markdown --out docs/routes`} />
        <P>
          <Strong>That's the tour.</Strong> Revisit the <A href="/docs/cli">CLI reference</A> for every
          flag, or the <A href="/docs/api">programmatic API</A> to build your own tooling on top of
          the graph.
        </P>
      </Prose>
    </DocPage>
