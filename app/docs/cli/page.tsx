...
node packages/cli/dist/cli.js <command> [options]`}
        ...
        <CodeBlock language="bash" code={`route-intelligence analyze --root . --format json --out ri-output`} />
        <Table
        ...
        <CodeBlock language="bash" code={`route-intelligence export --format mermaid --out ri-export`} />
        <P>
        ...
        <CodeBlock language="text" code={`Watching for route changes...
