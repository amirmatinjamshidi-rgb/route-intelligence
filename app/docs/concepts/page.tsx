  ...
  return (
    ...
    >
      <Prose>
        ...
        <P>
          Because it is a real graph, you can answer questions algorithmically: <em>Is this route
          reachable? Does this redirect loop? What links here? What is the shortest path from the
          home page to checkout?</em>
        </P>
